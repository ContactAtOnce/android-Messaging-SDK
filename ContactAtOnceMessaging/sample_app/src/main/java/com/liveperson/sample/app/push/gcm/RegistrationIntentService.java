...
public class RegistrationIntentService extends IntentService {
    ...
    private String authorizedEntity = "RegistrationIntentService"; // Project id from Google Developers Console
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                String token = instanceID.getToken("234151782597", GoogleCloudMessaging.INSTANCE_ID_SCOPE);
                // [END get_token]
